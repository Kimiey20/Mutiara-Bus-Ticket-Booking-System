...
<head>
    ...
    <title>Mutiara Bus Ticket Bookings</title>
    <!-- google fonts -->
...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">MBTBS</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Mutiara Bus Ticket Booking System</h1>

            <p class="text-center">Welcome to Mutiara Bus Ticket Booking System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                    Welcome to Mutiara Bus Ticket Booking System, where convenience meets seamless travel planning. At Mutiara, we take pride in revolutionizing your journey by offering a user-friendly and efficient platform to book bus tickets effortlessly. Our mission is to provide a stress-free travel experience, ensuring you reach your destination comfortably and on time. With a commitment to reliability and customer satisfaction, Mutiara Bus Ticket Booking System aims to redefine the way you travel, making every journey a memorable and hassle-free adventure. Join us on the road to unparalleled convenience and explore the world with confidence through our trusted bus ticket booking services.
                </p>
            </div>
        </section>
        <section id="contact">
    ...
    <form action="/action_page.php" target="_blank">
      ...
      <input type="submit" value="Submit">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Mutiara Bus Ticket Booking System
                    </p>
        </footer>
    </div>
